...
const Sidebar: React.FC = () => {
  ...
  return (
    <div
      className="sidebar dark:bg-coal-600 bg-coal-600 border-r border-r-gray-200 dark:border-r-coal-100 fixed top-0 bottom-0 z-20 hidden lg:flex flex-col items-stretch shrink-0"
      data-drawer="true"
    ...
    >
      ...
      >
        <a className="dark:hidden" href="html/demo1.html">
          <img
            className="default-logo min-h-[10px] w-[100px] max-w-none"
            src={logo}
          />
          <img
            className="small-logo min-h-[10px] w-[100px] max-w-none"
            src={logo}
          />
        </a>
          ...
          >
            ...
            <div className="menu-item">
              ...
              >
                ...
                <span
                  className="menu-title text-sm font-semibold text-gray-700"
